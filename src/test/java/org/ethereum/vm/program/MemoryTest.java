...
public class MemoryTest {
    ...
    public void memorySave_2() {
        ...
        Memory memoryBuffer = new Memory();
        byte[] data = HexUtil.fromHexString("0101010101010101010101010101010101010101010101010101010101010101");
    ...
    public void memorySave_3() {
        ...
        Memory memoryBuffer = new Memory();
        byte[] data = HexUtil.fromHexString("010101010101010101010101010101010101010101010101010101010101010101");
    ...
    public void memoryLoad_5() {
        ...
        assertArrayEquals(
                HexUtil.fromHexString("0101010101010101010101010101010101010101010101010101010101010101"),
                val1.getData());
